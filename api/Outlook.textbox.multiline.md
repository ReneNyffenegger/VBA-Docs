...
For controls that support the  **MultiLine** property as well as the **[WordWrap](Outlook.textbox.wordwrap.md)** property, **WordWrap** is ignored when **MultiLine** is **False**.
